...
public class AdminManagementsSteps { 
	...
	public void incluo_um_administrador(DataTable dataTable_) {
	   ...
	   addAdminPage.preencher_first_name(Helper.dataTable.get(0).get("Fisrt Name"));
	   addAdminPage.preencher_lastname(Helper.dataTable.get(0).get("Last Name"));
	...
	public void incluo_um_administrador_com_os_valores(String fisrtName, String lastName, String email, String password, String mobileNumber, String country, String address1, String address2, String status, String add, String edit, String remove) {
			
		   adminsManagementPage.clicar_btn_add();
		   Assert.assertTrue ("Página Add Admin NÃO apresentada.", addAdminPage.validar_pagina());
		   
		   addAdminPage.preencher_first_name(fisrtName);
		   addAdminPage.preencher_lastname(lastName);
	...
	@Então("{string} administrador cadastrado com sucesso")
	public void administrador_cadastrado_com_sucesso(String email) {
		Assert.assertTrue ("Email não encontrado.", adminsManagementPage.validar_email_na_tabela(email));
	}
